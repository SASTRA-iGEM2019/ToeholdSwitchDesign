...
bs_seq = "GGGUGAAUGAAUUGUAGGCUUGUUAUAGUUAUGAACAGAGGAGACAUAACAUGAACAAGCCUAACCUGGCGGCAGCGCAAAAGAUGCGUAAA"
db_seq = "((((..........((((((((((...((((((...........))))))...)))))))))))))).......(((((.....)))))..."
db_seq = db_seq.strip()

dom = re.match('^([\.\(\)]*\.)(\({9,})(\.{1,3})(\(*)(\.*)(\)*)(\.{1,3})(\)*)(\.[\.\(\)]*)$', db_seq) #regular expression match for domains based on grammar of toehold switch
